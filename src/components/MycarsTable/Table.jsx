...
const Table = ({ allTable, carsData, setCars }) => {
  ...
  <tr className="hover:bg-gray-50 transition duration-200">
    ...
    <td className="px-6 py-4 font-medium text-gray-800">{allTable.model}</td>
    <td className="px-6 py-4 text-green-600 font-semibold">${allTable.price}</td>
    <td className="px-6 py-4">
      <span
    ...
    <td className="px-6 py-4 text-sm text-gray-500">{allTable.dateAdded}</td>
    <td className="px-6 py-4">
