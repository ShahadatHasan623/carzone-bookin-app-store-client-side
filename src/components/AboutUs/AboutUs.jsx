  ...
  return (
    <div className="min-h-screen font-sans text-gray-800">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1503376780353-7e6692767f7d7?auto=format&fit=crop&w=1470&q=80')",
        }}
      ...
      >
        ...
        >
          ...
          <p className="text-base sm:text-xl md:text-2xl text-gray-200 max-w-lg mx-auto">
      ...
      <section className="max-w-7xl mx-auto my-12 md:my-16 px-5 lg:px-0 sm:px-6 grid gap-12 md:grid-cols-2">
        ...
        >
          <h2
            id="mission-heading"
            className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-4 text-gray-900"
          >
            Our Mission
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          {services.map(({ icon, title, description }) => (
            <motion.div
              ...
              className="bg-white rounded-3xl p-6 sm:p-10 shadow-lg flex flex-col items-center text-center cursor-pointer transition-transform duration-300"
              tabIndex={0}
              role="button"
              aria-pressed="false"
            >
              <div className="text-[var(--primary,#df732f)] text-4xl sm:text-5xl mb-6">
                {icon}
              </div>
              <h3 className="mt-6 sm:mt-8 text-xl sm:text-2xl font-semibold">
                {title}
              </h3>
              <p className="mt-3 sm:mt-4 max-w-xs text-sm sm:text-base">
                {description}
              </p>
            </motion.div>
          ))}
      ...
      {/* Stats */}
      <section className="bg-gradient-to-r from-orange-500 to-yellow-400 py-12 sm:py-16 text-white">
      ...
      >
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12 md:mb-14">
          Meet the Team
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-14">
          {teamMembers.map(({ name, role, photo, bio }) => (
            <motion.article
              ...
              className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 flex flex-col items-center text-center"
              tabIndex={0}
      ...
      {/* Contact CTA */}
      <section className="bg-orange-500 py-12 sm:py-16 text-white text-center rounded-xl max-w-7xl mx-auto px-5 sm:px-6 mb-16">
